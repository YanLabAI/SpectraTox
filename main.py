...
def train_IGC50():
    ## train ML
    train = np.array(pd.read_csv('./data/IGC50_train.csv', index_col=None).iloc[:,2:])
    train_tox = np.array(pd.read_csv('./data/IGC50_train.csv', index_col=None).iloc[:,1])
    test = np.array(pd.read_csv('./data/IGC50_test.csv', index_col=None).iloc[:,2:])
    test_tox = np.array(pd.read_csv('./data/IGC50_test.csv', index_col=None).iloc[:,1])
...
def train_Liver():
    train = np.array(pd.read_csv('./data/Liver_train.csv', index_col=None).iloc[:,2:])
    train_tox = np.array(pd.read_csv('./data/Liver_train.csv', index_col=None).iloc[:,1])
    test = np.array(pd.read_csv('./data/Liver_test.csv', index_col=None).iloc[:,2:])
    test_tox = np.array(pd.read_csv('./data/Liver_test.csv', index_col=None).iloc[:,1])
